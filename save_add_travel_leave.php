...
while($n1<$_POST['no_of_days'])
{
    ...
    if($n1==5){
        ...
        */
        ...
        //save to student logs
        $conn->query("INSERT INTO personnel_logs(RFTag_id, img, lname, fname, mname, suffix, do_id, shift_id, logDate, remarks, travel_leave_code)
        VALUES ('$applicant_rfid', '$img', '$pd1_row[lname]', '$pd1_row[fname]', '$pd1_row[mname]', '$pd1_row[suffix]', '$pd1_row[do_id]', '$pd1_row[shift_id]', '$logDate', '$remarks', '$_POST[leave_code]')");
        ...
        VALUES ('$_POST[leave_code]', '$final_logDate', '$remarks', '$_POST[leave_type_desc]', '$pd2_row[personnel_id]', '$pd1_row[personnel_id]', '$pd1_row[do_id]', '$_POST[no_of_days]')");
