...
<td style="border: none; font-size: 12px; background-color: white; padding: 0px 0px 0px 12px; font-weight: lighter;"><?php echo $sf_row['address']; ?></td>
            ...
            <td style="padding: 0px; border: none;">
                      ...
                      <tbody>
                            ...
                            $sr_query = $conn->query("SELECT * FROM service_record WHERE personnel_id='$_GET[personnel_id]' ORDER BY serv_date_from ASC") or die(mysql_error());
                        ...
                        <td style="background-color: white; padding: 2px; vertical-align: middle;"><?php echo $sr_row['salary']; ?></td>
                       ...
                       and in accordance with Circular No. 58, dated August 01, 1954 of the system.
                        ...
                        <table style="width: 100%; margin-left: 8px;">
                        <tr>
                        <td style="width: 50%; border: none;">Prepared by:</td>
                        <td style="width: 50%; border: none;">Certified correct:</td>
                        </tr>
                        <tr>
                        <td colspan="2" style="border: none;"><br /></td>
                        </tr>
                        <tr>
                        <td style="width: 50%; border: none;"><strong>JENNILYN M. VILLASIS</strong> &nbsp;&nbsp;&nbsp;&nbsp; Date: ___/___/______</td>
                        <td style="width: 50%; border: none;"><strong>ROSELLE J. MENDOZA</strong> &nbsp;&nbsp;&nbsp;&nbsp; Date: ___/___/______</td>
                        </tr>
                        <tr>
                        <td style="width: 50%; border: none;">PH III</td>
                        <td style="width: 50%; border: none;">MGADHI</td>
                        </tr>
                        </table>
