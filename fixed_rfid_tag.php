...
$fixCtr=0;                  
$printAll_Data_query = $conn->query("select personnel_id, lname, fname FROM personnels WHERE RFTag_id='' ORDER BY personnel_id ASC") or die(mysql_error());
while($printALL_row=$printAll_Data_query->fetch()){
        ...
        $conn->query("UPDATE personnels SET RFTag_id='$RFTag_id' WHERE personnel_id='$printALL_row[personnel_id]'");
