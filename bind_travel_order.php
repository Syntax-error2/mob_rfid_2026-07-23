...
<html>
  ...
  $to_query = $conn->query("SELECT * FROM personnel_official_travel_logs WHERE travel_code='$_POST[travel_code]'") or die(mysql_error());
                              ...
                              <div class="col-lg-12">
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <tbody>
                                    <?php
                                    $toData_query = $conn->query("SELECT personnel_id FROM personnel_official_travel_logs WHERE travel_code='$_POST[travel_code]'") or die(mysql_error());
                                    ...
                                    $staff_query = $conn->query("SELECT * FROM personnels WHERE personnel_id='$toBP_row[personnel_id]'") or die(mysql_error());    
                                    $staff_row = $staff_query->fetch();
