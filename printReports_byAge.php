                ...
                <hr />
                    ...
                    <table id="" class="display" style="width:100%">
                      ...
                      if($empStat_id>0){
                        ...
                        $printDataAge_query = $conn->query("SELECT personnel_id, lname, fname, mname, suffix, age, sex, do_id, des_id, empStat_id, bdMM, bdDD, bdYYYY FROM personnels WHERE (age BETWEEN '$ageFrom' AND '$ageTo') AND (separation_date='' OR separation_date='  /  /    ') AND empStat_id='$empStat_id' ORDER BY age, lname, fname ASC") or die(mysql_error());
                        ...
                        $printDataAge_query = $conn->query("SELECT personnel_id, lname, fname, mname, suffix, age, sex, do_id, des_id, empStat_id, bdMM, bdDD, bdYYYY FROM personnels WHERE (age BETWEEN '$ageFrom' AND '$ageTo') AND (separation_date='' OR separation_date='  /  /    ') ORDER BY age, lname, fname ASC") or die(mysql_error());
