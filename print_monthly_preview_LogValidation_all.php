...
$printAll_Data_query = $conn->query("select * FROM personnels ORDER BY lname, fname ASC") or die(mysql_error());
...
<div class="col-lg-12">
    ...
    <?php
    $LV_query = $conn->query("select * FROM personnel_logs WHERE RFTag_id='$printALL_row[RFTag_id]' AND logDate='$logDateCtr'") or die(mysql_error());
