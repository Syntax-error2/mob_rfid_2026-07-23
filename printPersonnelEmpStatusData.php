...
<body>
                    ...
                    <table id="example" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                $maleCtr=0;
                                $printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, age, do_id, des_id FROM personnels WHERE sex='Male' AND empStat_id='$_GET[empStat_id]' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                    ...
                    <table id="example2" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                $maleCtr=0;
                                $printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, age, do_id, des_id FROM personnels WHERE sex='Female' AND empStat_id='$_GET[empStat_id]' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                                while ($printDA_row=$printDataAge_query->fetch())
                                { $maleCtr=$maleCtr+1; ?>
                    ...
                    <table id="example" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                $maleCtr=0;
                                $printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, sex, age, do_id, des_id FROM personnels WHERE empStat_id='$_GET[empStat_id]' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                                while ($printDA_row=$printDataAge_query->fetch())
                                { $maleCtr=$maleCtr+1; ?>
