                ...
                <table class="table table-bordered">
                      ...
                      <!-- MONDAY --><!-- MONDAY --><!-- MONDAY --><!-- MONDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Monday'") or die(mysql_error());
                      ...
                      <!-- TUESDAY --><!-- TUESDAY --><!-- TUESDAY --><!-- TUESDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Tuesday'") or die(mysql_error());
                      ...
                      <!-- WEDNESDAY --><!-- WEDNESDAY --><!-- WEDNESDAY --><!-- WEDNESDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Wednesday'") or die(mysql_error());
                      ...
                      <!-- THURSDAY --><!-- THURSDAY --><!-- THURSDAY --><!-- THURSDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Thursday'") or die(mysql_error());
                      ...
                      <!-- FRIDAY --><!-- FRIDAY --><!-- FRIDAY --><!-- FRIDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Friday'") or die(mysql_error());
                      ...
                      <!-- SATURDAY --><!-- SATURDAY --><!-- SATURDAY --><!-- SATURDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Saturday'") or die(mysql_error());
                      ...
                      <!-- SUNDAY --><!-- SUNDAY --><!-- SUNDAY --><!-- SUNDAY -->
                            ...
                            $sched_query = $conn->query("select * FROM time_schedules WHERE do_id='$_GET[do_id]' AND  shift_id='$_GET[shift_id]' AND day='Sunday'") or die(mysql_error());
