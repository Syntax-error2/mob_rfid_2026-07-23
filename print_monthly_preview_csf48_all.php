...
$printAll_Data_query = $conn->query("SELECT * FROM personnels WHERE separation_date='' OR separation_date='  /  /    ' ORDER BY lname, fname ASC") or die(mysql_error());
while($printALL_row=$printAll_Data_query->fetch()){


$studData_query = $conn->query("select * FROM personnels WHERE RFTag_id='$printALL_row[RFTag_id]'") or die(mysql_error());
