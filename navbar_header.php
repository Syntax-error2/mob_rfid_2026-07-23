          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="home.php" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><strong class="text-primary">HRMS - RFID</strong><span>&nbsp;&nbsp;&nbsp;<?php echo date("l"); ?>, <?php echo date("M".". "."d".", "."Y"); ?></span></div></a> </div>
              ...
              <?php if($session_access==='User'){ ?>
                ...
                <?php }elseif($session_access==='Administrator' || $session_access==='Admin'){
