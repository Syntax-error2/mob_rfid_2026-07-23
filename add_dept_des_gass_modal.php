                      ...
                      <form action="save_add_dept_des_gass.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input name="gass_name" min="1" max="999" step="1" type="number" class="form-control" placeholder="Salary grade..." />
                              </div>
                            </div> 
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input name="ratePerDay" min="1.00" max="999999999.99" step="1" type="number" class="form-control" />
                              </div>
