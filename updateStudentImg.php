...
<html>
  ...
  <?php $personnel_id=$_GET['personnel_id']; ?>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              ...
              <!-- JHS           -->
                   ...
                   <?php
                   $subjK_query = $conn->query("select * FROM personnels WHERE personnel_id='$personnel_id'") or die(mysql_error());
              ...
              <div id="new-updates" class="card updates recent-updated">
                <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                  <h2 class="h5 display"> Update Personnel Image</h2>
                ...
                <div id="updates-boxJHS" role="tabpanel" class="collapse show">
                  <ul>
                    ...
                    <li class="d-flex justify-content-between"> 
                            ...
                            <input value="<?php echo $personnel_id; ?>" type="hidden" name="personnel_id" />
                            <input value="<?php echo $subjK_row['RFTag_id']; ?>" type="hidden" name="RFTag_id" />
                              ...
                              <div class="row">
                                ...
                                <br />
                                <img width="100%" height="100%" class="img-fluid rounded" src="personnelImg/<?php echo $subjK_row['img']; ?>" alt="current image image" />
                          ...
                          <a style="color: white;" href="list_personnel.php?dept=<?php echo $_GET['dept']; ?>" class="btn btn-secondary">Cancel</a>
