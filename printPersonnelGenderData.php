                ...
                messageBottom: '<center>Municipality of Binalbagan - Human Resource Management Office</center>'
                    ...
                    <table id="example" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                if($gender=='ALL'){
                                $printDataMale_query = $conn->query("SELECT lname, fname, mname, suffix, sex, do_id, des_id FROM personnels WHERE sex='Male' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                            ...
                            <td>
                             ...
                             <td><?php echo $printDM_row['sex']; ?></td>
                                ...
                                <?php $printDataFemale_query = $conn->query("SELECT lname, fname, mname, suffix, sex, do_id, des_id FROM personnels WHERE sex='Female' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                            ...
                            <td>
                             ...
                             <td><?php echo $printDF_row['sex']; ?></td>
                                ...
                                $printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, sex, do_id, des_id FROM personnels WHERE sex='$gender' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
