...
<?php
$studData_query = $conn->query("select * FROM personnels WHERE RFTag_id='$get_RFTag_id'") or die(mysql_error());
...
<?php
  ...
  <?php
  $SC_query3 = $conn->query("SELECT activity_id FROM activity_calendar WHERE completeDate='$logDateCtr' AND status='Add as working day'") or die(mysql_error());
  ...
  <?php } ?>
    ...
    <td colspan="6" style="background-color: #ececec;"><center><strong><?php if($dayName2=='Sat'){ echo "S A T U R D A Y"; } if($dayName2=='Sun'){ echo "S U N D A Y"; } ?></strong></center></td>
      ...
      $SC_query = $conn->query("select * FROM activity_calendar WHERE completeDate='$logDateCtr' AND status!='Add as working day'") or die(mysql_error());
  ...
  <?php
  $SC_query4 = $conn->query("select * FROM activity_calendar WHERE completeDate='$logDateCtr' AND status='Add as working day'") or die(mysql_error());
  ...
  <?php
  $SC_query2 = $conn->query("select * FROM activity_calendar WHERE completeDate='$logDateCtr' AND status='Add as working day'") or die(mysql_error());
