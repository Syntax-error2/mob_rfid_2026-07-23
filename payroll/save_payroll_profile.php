...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_profile'])) {
    try {
        ...
        if ($profile_id) {
            ...
            ob_end_clean();
            header('Location: view_payroll_profile.php?profile_id=' . $profile_id . '&successMsg=' . urlencode('Profile updated successfully'));
            exit();
            ...
            ob_end_clean();
            header('Location: view_payroll_profile.php?profile_id=' . $new_profile_id . '&successMsg=' . urlencode('Profile created successfully. Now add income and deduction items.'));
            exit();
        }
        ...
        if ($profile_id) {
            header('Location: view_payroll_profile.php?profile_id=' . $profile_id . '&errorMsg=' . $error_msg);
        } else {
            header('Location: list_payroll_profiles.php?errorMsg=' . $error_msg);
        }
        exit();
    }
}
