                ...
                <hr />
                    ...
                    <table id="" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                //$printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, do_id, des_id FROM personnels WHERE personnel_id='$peb_row[personnel_id]' AND ((separation_date='' OR separation_date='  /  /    '))");
