          ...
          <!-- kinder 1     -->
              <div id="new-updates" class="card updates recent-updated">
                <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <a style="color: white !important;" data-toggle="modal" data-target="#addGASS" href="#" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                  
                  &nbsp;&nbsp;<a data-toggle="collapse" data-parent="#new-updates" href="#updates-boxKinder" aria-expanded="true" aria-controls="updates-boxKinder">SALARY GRADE</a>
                ...
                <div id="updates-boxKinder" role="tabpanel" class="collapse show">
                    ...
                    <table id="" class="display" style="width:100%">
                      ...
                      <tbody>
                            ...
                            $subjK_query = $conn->query("SELECT * FROM gass ORDER BY gass_name ASC") or die(mysql_error());
