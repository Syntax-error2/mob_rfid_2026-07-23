...
$dept_off_query = $conn->query("SELECT * FROM dept_offices WHERE do_id='$_GET[do_id]'") or die(mysql_error());
$do_row = $dept_off_query->fetch();
       
$officeHead_query = $conn->query("SELECT * FROM personnels WHERE personnel_id='$do_row[officeHead_id]'") or die(mysql_error());
...
<body>
                    ...
                    <table style="width: 100%">
                        ...
                        <?php
                        $personCtr=0;
                        $studData_query = $conn->query("SELECT * FROM personnels WHERE do_id='$_GET[do_id]' AND (separation_date='' OR separation_date='  /  /    ') AND sex='Male' ORDER BY lname, fname ASC") or die(mysql_error());
...
<div class="pb" style="margin-top: 24px;"></div>
                    ...
                    <table style="width: 100%">
                        ...
                        <?php
                        $personCtr=0;
                        $studData_query = $conn->query("SELECT * FROM personnels WHERE do_id='$_GET[do_id]' AND (separation_date='' OR separation_date='  /  /    ') AND sex='Female' ORDER BY lname, fname ASC") or die(mysql_error());
                        while($staff_row=$studData_query->fetch()){
