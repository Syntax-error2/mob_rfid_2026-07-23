          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-8 col-12">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">EMPLOYEES 
                
                <a href="print_all_personnel.php" target="_blank" class="ml-2" title="Click to print all employees..."><i style="font-size: small;" class="fa fa-print"></i></a> 
                
                <a data-toggle="modal" data-target="#universal_report" href="#" class="ml-2" title="Click to print list of employee with advanced filters..."><i style="font-size: small;" class="fa fa-filter"></i></a>
            ...
            <div class="col-xl-3 col-md-8 col-12">
              <div class="wrapper count-title d-flex">
                ...
                <?php
                $empStatCtr_query = $conn->query("SELECT * FROM personnels WHERE empStat_id='$empStat_row[empStat_id]' AND (separation_date='' OR separation_date='  /  /    ')") or die(mysql_error());
