      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <!---li><a href="home_user.php"><i class="fa fa-calendar"></i>Travel &amp; Leave History</a></li>--->
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">  
            ...
            <li><a href="#payroll_dd" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i>Payroll System </a>
              <ul id="payroll_dd" class="collapse list-unstyled ">
                ...
                <li><a href="payroll/list_payroll_profiles.php"> <i class="fa fa-folder-open"></i>Payroll Templates</a></li>
                <li><a href="payroll/list_payroll_history.php"> <i class="icon-clock"></i>Payroll History</a></li>
              </ul>
            </li>
