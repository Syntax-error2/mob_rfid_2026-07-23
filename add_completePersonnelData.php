...
<html>
  ...
  <?php include('menu_sidebar.php'); ?>
    ...
    <!-- Breadcrumb-->
      ...
      <?php
      $personnel_query = $conn->query("SELECT * FROM personnels WHERE personnel_id_code='$_GET[personnel_id_code]'") or die(mysql_error());
        ...
        <div class="container-fluid">
          <div class="row">
                              ...
                              <div class="col-sm-12">
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <option>-</option>
                                    <?php
                                    $emp_stat_query = $conn->query("select * from gass ORDER BY gass_name ASC");
                                    while($es_row=$emp_stat_query->fetch()){
                                    ?>
            ...
            <div class="footer" style="margin-bottom: 12px;">
              ...
              <a href="list_personnel.php?dept=<?php echo $_GET['dept']; ?>" class="btn btn-secondary" style="color: white; float: left; margin-left: 12px;">Cancel</a>
