      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <?php
            $do_id_name_query = $conn->query("SELECT * FROM dept_offices WHERE do_id='$_GET[dept]'") or die(mysql_error());
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <?php
                $dept_off_query = $conn->query("SELECT * FROM dept_offices ORDER BY dept_office_name ASC") or die(mysql_error());
              ...
              <div id="new-updates" class="card updates recent-updated">
                ...
                <?php }else{?>
                  ...
                  <a data-toggle="collapse" data-parent="#new-updates" href="#updates-boxKinder" aria-expanded="true" aria-controls="updates-boxKinder"><h4><?php if($_GET['dept']!=''){
                    ...
                    $dept_off_name_query = $conn->query("SELECT * FROM dept_offices WHERE do_id='$_GET[dept]'") or die(mysql_error());
