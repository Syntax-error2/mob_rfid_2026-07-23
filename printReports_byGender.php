                ...
                <hr />
                    ...
                    <table id="" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                $printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, sex, do_id, des_id FROM personnels WHERE sex='Male' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                        ...
                        <table id="" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                $printDataAge_query = $conn->query("SELECT lname, fname, mname, suffix, sex, do_id, des_id FROM personnels WHERE sex='Female' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname ASC") or die(mysql_error());
                                while ($printDA_row=$printDataAge_query->fetch())
                                { ?>
